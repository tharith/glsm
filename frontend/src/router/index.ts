    ...
    },
    {
      ...
      children: [
        ...
        // ── Approvals ───────────────────────────────────────
        {
          ...
          meta: { roles: ['OFFICE_CHIEF','DEPARTMENT_CHIEF','HR_OFFICER','DIRECTOR_GENERAL','INSTITUTION_HEAD'] },
        },
        ...
        // ── Reports ─────────────────────────────────────────
        {
          ...
          meta: { roles: ['SYSTEM_ADMIN','HR_OFFICER','DIRECTOR_GENERAL','INSTITUTION_HEAD'] },
        },
        ...
        // ── Public Holidays ─────────────────────────────────
        {
          ...
          component: () => import('@/views/public-holidays/PublicHolidaysView.vue'),
          meta: { roles: ['SYSTEM_ADMIN','HR_OFFICER'] },
        },
        ...
        // ── Delegations ─────────────────────────────────────
        {
          ...
          meta: { roles: ['SYSTEM_ADMIN','INSTITUTION_HEAD','DIRECTOR_GENERAL','DEPARTMENT_CHIEF','OFFICE_CHIEF'] },
        },
        ...
        // ── My Profile ─────────────────────────────────────
        { path: 'profile', component: () => import('@/views/profile/MyProfileView.vue') },
